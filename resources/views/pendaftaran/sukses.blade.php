...
@section('content')
    <section class="my-16 max-w-2xl mx-auto px-4">
        <div class="bg-white/10 backdrop-blur-xl p-8 rounded-lg shadow-lg text-center text-white">
            <h1 class="text-4xl md:text-5xl font-extrabold text-green-300 mb-4">Pendaftaran Berhasil!</h1>
