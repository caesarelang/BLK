...
<body class="font-sans antialiased text-gray-800 flex flex-col min-h-screen">
    <!-- Navbar -->
    <header class="bg-white/10 backdrop-blur-xl sticky top-0 z-50">
        <div x-data="{ open: false }" class="relative max-w-4xl mx-auto px-4">
            <div class="flex justify-between items-center py-6">
                <!-- Left Section: Logo & Nav Links -->
                <div class="flex items-center space-x-8">
                    <div>
                        <a href="/" class="text-2xl font-bold text-white">Balai Latihan Kerja</a>
                        <p class="text-sm text-gray-200">Kabupaten Kediri</p>
                    </div>
                    <nav class="hidden md:flex items-center space-x-8">
                        <a href="/" class="text-gray-200 hover:text-white font-medium">Home</a>
                        <a href="{{ route('kejuruan') }}" class="text-gray-200 hover:text-white font-medium">Kejuruan</a>
                        <a href="{{ route('pengumuman') }}" class="text-gray-200 hover:text-white font-medium">Pengumuman</a>
                    </nav>
                </div>
    ...
    <!-- Footer -->
    <footer class="bg-white/10 backdrop-blur-xl text-white mt-16 pt-12 pb-8">
        <div class="max-w-4xl mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- About Section -->
                <div>
                    <h3 class="text-lg font-semibold text-white">Balai Latihan Kerja</h3>
                    <p class="mt-2 text-sm text-gray-200">Menyediakan pelatihan berkualitas untuk meningkatkan kompetensi dan daya saing tenaga kerja di era digital.</p>
                </div>
                
                <!-- Contact & Social Media Section -->
                <div>
                    <div>
                        <h3 class="text-lg font-semibold text-white">Alamat Kami</h3>
                        <address class="mt-2 text-sm not-italic text-gray-200">
                        Jl. PLK No.9, Mulyosari, Bogokidul,<br>
                        Kec. Plemahan, Kabupaten Kediri,<br>
                        Jawa Timur 64155<br>
                            <a href="tel:021-123-4567" class="hover:text-white">Telp: (021) 123-4567</a><br>
                            <a href="mailto:info@blk.go.id" class="hover:text-white">Email: info@blk.go.id</a>
                        </address>
                    </div>
                    <div class="mt-8">
                        <h3 class="text-lg font-semibold text-white">Media Sosial</h3>
                ...
                <div>
                    <h3 class="text-lg font-semibold text-white mb-4">Lokasi Kami</h3>
