...
<body class="font-sans antialiased bg-gray-50 text-gray-800 flex flex-col min-h-screen">
    <!-- Navbar -->
    <header class="bg-gray-50/90 backdrop-blur-sm sticky top-0 z-50">
    ...
    <!-- Footer -->
    <footer class="bg-white text-gray-700 mt-16 pt-12 pb-8">
        <div class="max-w-4xl mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- About Section -->
                <div>
                    <h3 class="text-lg font-semibold text-gray-900">Balai Latihan Kerja</h3>
                    <p class="mt-2 text-sm">Menyediakan pelatihan berkualitas untuk meningkatkan kompetensi dan daya saing tenaga kerja di era digital.</p>
                </div>
                
                <!-- Contact & Social Media Section -->
                <div>
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900">Alamat Kami</h3>
                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">Lokasi Kami</h3>
